...
*/
  def eq(lib: String, fileName: String): String = {
    //pop pop compute push
    var translateSeg = "\n//EQ" +
      "\n@SP" +
      "\nA=M-1" +
  ...
  def gt(lib: String, fileName: String): String = {
    //pop pop compute push
    var translateSeg = "\n//GT" + "\n@SP" +
      "\nA=M-1" +
      "\nD=M" +
  ...
  def lt(lib: String, fileName: String): String = {
    //pop pop compute push
    var translateSeg = "\n//LT" + "\n@SP" +
      "\nA=M-1" +
      "\nD=M" +
  ...
  def returnFunc(segment: String ): String = {
    var translateSeg = "\n//RETURN" + "\n@SP" +
      "\nA=M-1" +
      "\nM=!M\n"
    return translateSeg
